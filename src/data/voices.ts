...
export const defaultVoices: Voice[] = [
  { id: 'alloy', name: 'Alloy', description: 'Neutral and balanced voice - versatile for all content types', type: 'standard', useCases: 'General purpose, tutorials, announcements' },
  ...
  { id: 'ballad', name: 'Ballad', description: 'Smooth and melodic neural voice - engaging narration', type: 'neural', useCases: 'Storytelling, audiobooks, creative content' },
  ...
  { id: 'echo', name: 'Echo', description: 'Resonant and clear standard voice - strong presence', type: 'standard', useCases: 'Announcements, important messages' },
  ...
  { id: 'fable', name: 'Fable', description: 'Expressive and warm standard voice - storytelling excellence', type: 'standard', useCases: 'Audiobooks, narrative content' },
  { id: 'jade-hardy', name: 'Jade Hardy', description: 'Confident and strong HD voice - premium quality', type: 'hd', useCases: 'High-quality narration, professional broadcasts' },
  ...
  { id: 'megan-wetherall', name: 'Megan Wetherall', description: 'Professional and polished HD voice - broadcast quality', type: 'hd', useCases: 'News broadcasts, premium content' },
  { id: 'nova', name: 'Nova', description: 'Bright and energetic standard voice - engaging delivery', type: 'standard', useCases: 'Educational content, tutorials' },
  { id: 'onyx', name: 'Onyx', description: 'Deep and authoritative standard voice - commanding presence', type: 'standard', useCases: 'Documentaries, serious content' },
  ...
  { id: 'shimmer', name: 'Shimmer', description: 'Bright and cheerful standard voice - optimistic tone', type: 'standard', useCases: 'Positive messaging, uplifting content' },
